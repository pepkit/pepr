...
This vignette will show you how and why to use the derived attributes functionality of the `pepr` package. For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/). For a broader theoretical description of derived attributes click [here](https://pepkit.github.io/docs/derived_attributes/).
