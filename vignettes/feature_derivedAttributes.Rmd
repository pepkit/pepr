---
title: "Derived attributes in pepr"
...
This vignette will show you how and why to use the derived attributes functionality of the `pepr` package. For introductory information about the package visit the [documentation page](http://code.databio.org/pepr/index.html). For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/). For a broader theoretical description of derived attributes click [here](https://pepkit.github.io/docs/derived_attributes/).

## Problem/Goal
The example below demonstrates how to use the derived attributes to **flexibly define the samples attributes the `file_path` column** of the `sample_annotation.csv` file to match the file names in  your project. Please consider the example below for reference:
