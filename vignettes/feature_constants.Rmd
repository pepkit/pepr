...
# Learn constants in `pepr`

This vignette will show you how and why to use the constants functionality of the `pepr` package.For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/).
