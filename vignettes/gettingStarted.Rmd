...
To fetch private PEPs, use PEPhub Client to login and generate an authentication token. You should then be able to fetch your private PEPs by registry path.
