...
Load `pepr` and read in your project. We have provided a basic example to show you how it works. You can use this get the path to the load the project configuration `yaml` file:
