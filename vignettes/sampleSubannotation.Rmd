...
library(pepr)
project_config = system.file("extdata","example_peps-master", "examples_subannotation","example1", "project_config.yaml", package="pepr")
printNestedList(yaml::read_yaml(project_config))
```
* Sample annotation table:
```{r ,echo=FALSE}
library(knitr)
sampleAnnotation = system.file("extdata","example_peps-master", "examples_subannotation","example1", "sample_annotation.csv", package="pepr")
...
```{r ,echo=FALSE}
sampleAnnotation = system.file("extdata","example_peps-master", "examples_subannotation","example1", "sample_subannotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
...
```{r}
library(pepr)
projectConfig1=system.file("extdata", "example_peps-master","examples_subannotation","example1", "project_config.yaml", package="pepr")
...
```{r, echo=FALSE,message=TRUE,collapse=TRUE,comment=" "}
library(pepr)
project_config = system.file("extdata", "example_peps-master","examples_subannotation","example2", "project_config.yaml", package="pepr")
printNestedList(yaml::read_yaml(project_config))
```
* Sample annotation table:
```{r ,echo=FALSE}
library(knitr)
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example2", "sample_annotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
* Sample subannotation table:
```{r ,echo=FALSE}
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example2", "sample_subannotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
Let's load the project config, create the Project object and see if multiple files are present 
```{r}
library(pepr)
projectConfig2=system.file("extdata", "example_peps-master","examples_subannotation","example2", "project_config.yaml", package="pepr")
...
```{r, echo=FALSE,message=TRUE,collapse=TRUE,comment=" "}
library(pepr)
project_config = system.file("extdata", "example_peps-master","examples_subannotation","example3", "project_config.yaml", package="pepr")
printNestedList(yaml::read_yaml(project_config))
```
* Sample annotation table:
```{r ,echo=FALSE}
library(knitr)
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example3", "sample_annotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
* Sample subannotation table:
```{r ,echo=FALSE}
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example3", "sample_subannotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
Let's load the project config, create the Project object and see if multiple files are present 
```{r}
library(pepr)
projectConfig3=system.file("extdata", "example_peps-master","examples_subannotation","example3", "project_config.yaml", package="pepr")
...
```{r, echo=FALSE,message=TRUE,collapse=TRUE,comment=" "}
library(pepr)
project_config = system.file("extdata", "example_peps-master","examples_subannotation","example4", "project_config.yaml", package="pepr")
printNestedList(yaml::read_yaml(project_config))
```
* Sample annotation table:
```{r ,echo=FALSE}
library(knitr)
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example4", "sample_annotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
* Sample subannotation table:
```{r ,echo=FALSE}
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example4", "sample_subannotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
Let's load the project config, create the Project object and see if multiple files are present 
```{r}
library(pepr)
projectConfig4=system.file("extdata", "example_peps-master","examples_subannotation","example4", "project_config.yaml", package="pepr")
...
```{r, echo=FALSE,message=TRUE,collapse=TRUE,comment=" "}
library(pepr)
project_config = system.file("extdata", "example_peps-master","examples_subannotation","example5", "project_config.yaml", package="pepr")
printNestedList(yaml::read_yaml(project_config))
```
* Sample annotation table:
```{r ,echo=FALSE}
library(knitr)
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example5", "sample_annotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
* Sample subannotation table:
```{r ,echo=FALSE}
sampleAnnotation = system.file("extdata", "example_peps-master","examples_subannotation","example5", "sample_subannotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
kable(sampleAnnotationDF,format = "html") 
```
Let's load the project config, create the Project object and see if multiple files are present 
```{r}
library(pepr)
projectConfig5=system.file("extdata", "example_peps-master","examples_subannotation","example5", "project_config.yaml", package="pepr")
