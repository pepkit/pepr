...
This vignette will show you how and why to use the derived columns functionality of the `pepr` package. For introductory information about the package visit the [documentation page](http://code.databio.org/pepr/index.html). For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/). For a broader theoretical description of derived columns click [here](https://pepkit.github.io/docs/derived_columns/).
