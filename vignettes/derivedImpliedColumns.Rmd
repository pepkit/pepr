...
```{r,echo=FALSE}
sampleAnnotation = system.file("extdata", "example_derived_implied", "sample_annotation.csv", package="pepr")
sampleAnnotationDF=read.table(sampleAnnotation,sep = ",",header = T)
knitr::kable(sampleAnnotationDF,format = "html") 
```
...
```{r}
library(pepr)
projectConfig = system.file("extdata", "example_derived_implied", "project_config.yaml", package="pepr")
