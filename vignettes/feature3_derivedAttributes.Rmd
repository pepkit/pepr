...
This vignette will show you how and why to use the derived attributes functionality of the `pepr` package. 
 ...
 - broader theoretical description in the derived attributes [documentation section](https://pepkit.github.io/docs/derived_attributes/).
