...
This vignette will show you how and why to use the derieved attributes and implied attributes functionalities concurrently of the `pepr` package. 
 ...
 - Make sure to study the dedicated [derived attributes](./derivedAttributes.Rmd) and [implied attributes](./impliedAttributes.Rmd) vignettes prior to reading this one
