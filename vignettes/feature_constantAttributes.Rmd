...
Let's introduce a few modifications to the original `sample_annotation.csv` file to use the `constant_attributes` section of the config. Simply skip the attributes that are set constant and let the `pepr` do the work for you.
