...
This vignette will show you how and why to use the implied attributes functionality of the `pepr` package. For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/). For a broader theoretical description of implied attributes click [here](https://pepkit.github.io/docs/implied_attributes/).
