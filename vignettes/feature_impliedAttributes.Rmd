---
title: "Implied attributes in pepr"
...
This vignette will show you how and why to use the implied attributes functionality of the `pepr` package. For introductory information about the package visit the [documentation page](http://code.databio.org/pepr/index.html). For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/). For a broader theoretical description of implied attributes click [here](https://pepkit.github.io/docs/implied_attributes/).
...
Let's introduce a few modifications to the original `sample_annotation.csv` file to use the `implied_attributes` section of the config. Simply skip the attributes that will be implied and let the `pepr` do the work for you.
