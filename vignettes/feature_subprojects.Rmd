...
This vignette will show you how and why to use the subbprojects functionality of the `pepr` package. For the basic information about the PEP concept visit the [project website](https://pepkit.github.io/).
...
In case you don't remember the subproject names run the `listSubprojects()` function on the config of the `Project` object, just like that:

```{r}
listSubprojects(config(p))
```
